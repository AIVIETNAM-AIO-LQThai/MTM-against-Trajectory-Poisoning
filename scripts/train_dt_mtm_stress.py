...
def main() -> None:
    ...
    if args.resume is not None:
        ...
        raise ValueError("Group 4D requires an explicit --output-dir")
    ...
    print("=" * 72)
    print("GROUP 4D POISONED DT+MTM TRAINING")
    print("=" * 72)
    print("device:", device)
    ...
    # Poisoned trajectories drive both DT and MTM training.
    # All preprocessing statistics remain frozen from clean data.
    clean_reference_data = load_clean_walker2d()
    data = load_clean_walker2d(dataset_path=args.dataset)

    tokenizers = build_mtm_tokenizers(
    ...
    # Probe remains a fixed clean-reference diagnostic.
    ...
    print()
    print("=" * 72)
    print("GROUP 4D DT+MTM TRAINING STOPPED AT REQUESTED STEP")
    print("=" * 72)
